...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/SL/Test.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">Test</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="Test.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="Test.asmx?op=HelloWorld">HelloWorld</a>
